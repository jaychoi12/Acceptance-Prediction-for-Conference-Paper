...
class InputExample(object):
    ...
    def __init__(self, guid, text_a, text_b=None, label=None, meta_data=None):
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, segment_ids, label_id, meta_data):
...
def convert_examples_to_features(examples, max_seq_length, tokenizer, print_examples=False):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        # meta_data 안에 있는 데이터들 다 float으로 만들어야 함.
